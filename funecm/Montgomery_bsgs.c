...
void montgomery_bsgs(mpz_t p,PROJECTIVE_POINT P,const unsigned long int B1,const unsigned long int B2,const int window_size,const mpz_t N,const FILE *fp,const mpz_t D,const mpz_t ma, const mpz_t mb){
